...
user_input['Tenure'] = st.sidebar.slider('Tenure (in years) ', min_value=0, max_value=10, value=5)
...
user_input['HasCrCard'] = st.sidebar.selectbox('Has Credit Card (Yes=1, No=0) ', [0, 1])
user_input['IsActiveMember'] = st.sidebar.selectbox('Is Active Member (Yes=1, No=0)', [0, 1])
